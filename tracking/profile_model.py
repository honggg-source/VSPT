...
def parse_args():
    ...
    parser.add_argument('--config', type=str, default='vitb_256_mae_32x4_ep60', help='yaml configure file name')
...
if __name__ == "__main__":
    ...
    args = parse_args()
    '''update cfg'''
    yaml_fname = '/home/sch/VSPT/experiments/%s/%s.yaml' % (args.script, args.config)
