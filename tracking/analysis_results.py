...
# trackers.extend(trackerlist(name='stark_st', parSameter_name='baseline_R101', dataset_name=dataset_name,
#                             run_ids=None, display_name='STARK-ST101'))
"""TransT"""
# trackers.extend(trackerlisSt(name='TransT_N2', parameter_name=None, dataset_name=None,
...
"""ostrack"""
trackers.extend(trackerlist(name='ostrack', parameter_name='vitb_256_mae_32x4_ep60', dataset_name=dataset_name,
...
# plot_results(trackers, dataset, 'LSOTB', merge_results=True, plot_types=('success', 'norm_prec'),
