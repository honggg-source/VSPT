...
from lib.train.dataset import Lasot_lmdb, Got10k_lmdb, MSCOCOSeq_lmdb, ImagenetVID_lmdb, TrackingNet_lmdb,LSOTB_lmdb
...
def get_optimizer_scheduler(net, cfg):
    ...
    if 'Adapter' in train_type:
        ...
        param_dicts = [
            {"params": [p for n, p in net.named_parameters() if "Adapter_" in n and p.requires_grad]}
        ]
