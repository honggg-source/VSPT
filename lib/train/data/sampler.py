    ...
    def getitem(self):
        ...
        while not valid:
            ...
            try:
                ...
                # 2021/2/5 坐标转换
                template_x1, template_y1, template_x2, template_y2 = template_anno['bbox'][0]
                # 计算宽度和高度
                template_width = template_x2 - template_x1
                template_height = template_y2 - template_y1
                template_anno['bbox'] = [torch.tensor([template_x1, template_y1, template_width, template_height])]

                search_x1, search_y1, search_x2, search_y2 = search_anno['bbox'][0]
                # 计算宽度和高度
                search_width = search_x2 - search_x1
                search_height = search_y2 - search_y1
                search_anno['bbox'] = [torch.tensor([search_x1, search_y1, search_width, search_height])]
