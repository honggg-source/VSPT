...
def main():
    ...
    args = parser.parse_args(['--script','ostrack','--config','vitb_256_mae_32x4_ep60','--save_dir','./output','--use_lmdb','0',
                              '--script_prv','None','--config_prv','baseline','--distill','0','--script_teacher','None',
                              '--config_teacher','None','--use_wandb','0'])
