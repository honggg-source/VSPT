...
# MODEL
cfg.MODEL = edict()
cfg.MODEL.PRETRAIN_FILE = "D:/tracker_code/OSTrack-main/lib/models/ostrack/pretrained_models/OSTrack_ep0300.pth.tar"
cfg.MODEL.PRETRAIN_FILE_MAE = "D:/tracker_code/OSTrack-main/lib/models/ostrack/pretrained_models/InfMAE.pth"
...
cfg.TRAIN.PROMPT.TYPE = 'peft'  # vipt_deep vipt_shaw
cfg.TRAIN.LR = 0.0001
